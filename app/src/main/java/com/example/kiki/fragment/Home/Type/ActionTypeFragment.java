...
public class ActionTypeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        actionRecyclerView = view.findViewById(R.id.actionTypeRecyclerView);
        ...
        actionRecyclerView.setLayoutManager(new LinearLayoutManager(getContext(), RecyclerView.VERTICAL, false));
